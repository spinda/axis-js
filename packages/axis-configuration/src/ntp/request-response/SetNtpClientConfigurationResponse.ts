...
export class SetNtpClientConfigurationResponse extends JsonDeviceResponse {
    ...
    public assertSuccess(): void {
        ...
        throw new UnknownError('Request to set NTP client configuration was not successful');
    }
}
