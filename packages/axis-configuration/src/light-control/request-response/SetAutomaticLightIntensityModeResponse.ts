...
export class SetAutomaticLightIntensityModeResponse extends JsonDeviceResponse {
    ...
    public assertSuccess(): void {
        ...
        throw new UnknownError('Request to set automatic intensity mode was not successful');
    }
}
