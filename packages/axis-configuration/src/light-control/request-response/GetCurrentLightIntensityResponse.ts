...
export class GetCurrentLightIntensityResponse extends JsonDeviceResponse {
    private internalData?: CurrentLightIntensityData;
    ...
    public assertSuccess(): void {
        ...
        throw new UnknownError('Request for current intensity was not successful');
    }

    public get data(): CurrentLightIntensityData {
