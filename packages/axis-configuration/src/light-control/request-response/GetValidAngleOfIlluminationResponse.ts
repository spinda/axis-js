...
export class GetValidAngleOfIlluminationResponse extends JsonDeviceResponse {
    private internalData?: ValidAngleOfIlluminationData;
    ...
    public assertSuccess(): void {
        ...
        throw new UnknownError('Request for valid angle of illumination was not successful');
    }

    public get data(): ValidAngleOfIlluminationData {
