...
export class SetIndividualLightIntensityResponse extends JsonDeviceResponse {
    ...
    public assertSuccess(): void {
        ...
        throw new UnknownError('Request to set individual intensity was not successful');
    }
}
