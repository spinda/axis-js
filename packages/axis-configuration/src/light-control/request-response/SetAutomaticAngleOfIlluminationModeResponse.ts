...
export class SetAutomaticAngleOfIlluminationModeResponse extends JsonDeviceResponse {
    ...
    public assertSuccess(): void {
        ...
        throw new UnknownError('Request to set automatic angle of illumination mode was not successful');
    }
}
