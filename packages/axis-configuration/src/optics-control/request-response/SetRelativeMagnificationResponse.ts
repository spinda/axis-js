...
export class SetRelativeMagnificationResponse extends JsonDeviceResponse {
    ...
    public assertSuccess(): void {
        ...
        throw new UnknownError('Request to set relative magnification was not successful');
    }
}
